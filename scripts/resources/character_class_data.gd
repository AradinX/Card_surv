...
extends Resource
## Definition of a playable class (Kucharz, Budowlaniec, Weteran) —
...
## Multiplier on hunger restored by food (Kucharz 2.0, Budowlaniec < 1).
...
## Extra energy cost of building cards (Kucharz/Weteran +1).
...
## Flat reduction of monster damage dealt to the player (Weteran).
@export var monster_damage_reduction: int = 0
## Extra daily hunger decay (Weteran +1, negative = hardier appetite).
