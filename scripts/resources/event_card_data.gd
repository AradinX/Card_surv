...
## Extra energy cost added to EVERY tile move tomorrow (fog-like conditions).
...
## Restricts the card to one disaster: it enters the night pool only after BUM
## and only when the active DisasterData.id matches. "" = no restriction.
